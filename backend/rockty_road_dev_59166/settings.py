"""
Django settings for rockty_road_dev_59166 project.
...
ROOT_URLCONF = 'rockty_road_dev_59166.urls'
...
WSGI_APPLICATION = 'rockty_road_dev_59166.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rockty_road_dev_59166 API",
    "DESCRIPTION": "API documentation for rockty_road_dev_59166 App",
    "VERSION": "v1",
}
